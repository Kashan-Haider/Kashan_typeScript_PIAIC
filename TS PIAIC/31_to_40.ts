...
arr3=[     ]
for(var j: number = 0; j < arr3.length; j++){  
    arr3[j] = arr3[j].trim()
 }
if(arr3.length == 0){
...
for(var a : number = 0; a<users.length ;a++){
    for(var j :number = 0 ; j< new_users.length ; j++){
...
for(var a : number = 0 ; a<arr4.length ; a++){
    if(arr4[a]==1){
...
for(var a : number = 0 ; a<pizzas.length ; a++){   
 console.log(pizzas[a])
}
//Modified
for(var a : number = 0 ; a<pizzas.length ; a++){   
    console.log(`I Like ${pizzas[a]} pizza`)
   }
...
var city1 : string = "Lahore"
var country1 : string = "Pakistan"
var city2 : string = "Karachi"
var country2 : string = "Pakistan"
var city3 : string = "Mumbai"
var country3 : string = "India"
...
//            Exercise # 40
var name1 : string = "Abuzar"
var track1 : string = "abc"
var name2 : string = "Sagheer"
var track2 : string = "jkl"
var name3 : string = "Kashan"
var track3 : string = "xyz"
var a =0
