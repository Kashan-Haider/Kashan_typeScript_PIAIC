...
//            Exercise # 12
var friends   = ['ali' , 'hussnain' , 'abbas'] 
console.log(`Hii ${friends[0]} , how are you ?`)
console.log(`Hii ${friends[1]} , how are you ?`)
console.log(`Hii ${friends[2]} , how are you ?`)

//            Exercise # 13
var transportations   = ['Honda Motorcycle' , 'Rolls Royce' , 'Mercedese'] 
console.log(`I would like to have a ${transportations[0]}`)
console.log(`I would like to have a ${transportations[1]}`)
console.log(`I would like to have a ${transportations[2]}`)

//            Exercise # 14
var guests   = ['ali' , 'hussnain' , 'abbas'] 
console.log(`Hii ${guests[0]} , you are invited for dinner !`)
console.log(`Hii ${guests[1]} , you are invited for dinner !`)
console.log(`Hii ${guests[2]} , you are invited for dinner !`)

//            Exercise # 15
var guests   = ['ali' , 'hussnain' , 'abbas'] 
console.log(`${guests[0]} can't come for dinner !`)
guests[0] = "akbar"
console.log(`${guests[0]} , will be our new guest !`)
console.log(`Hii ${guests[0]} , you are invited for dinner !`)
console.log(`Hii ${guests[1]} , you are invited for dinner !`)
console.log(`Hii ${guests[2]} , you are invited for dinner !`)
...
//            Exercise # 19
console.log(guests)
console.log(`I'm inviting ${guests.length} peapole on dinner`)
